...
def create_onto_protein_data(
    ...
    with open(fin_protein_seq_path, 'r') as f:
        ...
        for idx, line in enumerate(f.readlines()):
            ...
            protein2id[protein] = idx + protein_id_offset
...
if __name__ == '__main__':
    create_uniprot_data('data/uniprot_sprot.dat', 'data/PSKG/protein_seq_map.txt')
    create_goa_triplet('data/goa_uniprot_all.gaf', 'data/PSKG/protein_go_triplet', 'data/PSKG/protein_seq_map.txt')

    create_go_data(
       fin_path='data/go.obo',
       fout_graph_path='data/PSKG/go_graph.txt',
       fout_detail_path='data/PSKG/go_detail.txt',
       fout_leaf_path='data/PSKG/go_leaf.txt'
    )

    create_onto_protein_data(
        fin_go_graph_path='data/PSKG/go_graph.txt',
        fin_go_detail_path='data/PSKG/go_detail.txt',
        fin_goa_path='data/PSKG/protein_go_triplet',
        fin_protein_seq_path='data/PSKG/protein_seq_map.txt',
        fout_path='data/PSKG/pretrain_data'
    )
